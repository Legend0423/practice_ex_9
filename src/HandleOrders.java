    ...
    public void takeOrder() {
        ...
        do {
            ...
            if (choice > 0 && choice < 6) {
                ...
                StringBuilder customPizzaSummary = new StringBuilder(" Custom Pizza with ");
                customPizzaSummary.append(customPizzaToppings).append(": €").append(customPizzaPrice);
                pizzasOrdered[j] = customPizzaSummary.toString();
